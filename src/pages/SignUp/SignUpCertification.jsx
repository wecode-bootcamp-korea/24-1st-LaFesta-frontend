...
import './SignUpCertification.scss';

class SignUpCertification extends Component {
  constructor(props) {
    super(props);
  ...
  goToNext = () => {
    if (this.state.checked) {
      this.props.history.push('/SignUpUserInfo');
    } else {
      alert('체크박스는 필수사항입니다');
    }
  };
        ...
        <div className="backgroudBanner">
          <div className="container">
            ...
            <div className="detail one">
              ...
              제9호(시행일 2006년 9월 25일), 정보통신망 이용촉진 및 정보보호
            ...
            <div className="detail two">
              ...
              사이트에서는 주민등록번호를 받지 않습니다. 본인인증을 위해
              입력하신 개인정보는 본인인증기관에서 수집하는 정보이며, 이때
              수집된 정보는 본인인증 외 어떤 용도로도 이용되거나 별도 저장되지
              않습니다. 만 14세 미만 고객께서는 보호자(법정대리인)와 같이
              가입해주시기 바랍니다.
            </div>
          </div>
        </div>
